...
export default function ResidentForm() {
  ...
  const handleSubmit = (e) => {
    ...
    setFormData({
      ...
      emergencyContactName: '',
      emergencyContactNumber: '',
      Aadhar_card_frontSide: null,
      Aadhar_card_backSide: null,
      Address_Proof_VeraBill_or_LightBill: null,
      rentAgreement: null,
      aadharFrontPreview: '',
      aadharBackPreview: '',
      addressProofPreview: '',
  ...
  return (
    <div className="d-flex flex-column flex-md-row">
      ...
      <div className='dashboard-bg stickyHeader' style={{ width: "1900px" }}>
        ...
        <div className="container p-5 " style={{ maxWidth: '1550px', marginLeft: '325px', marginTop: '129px' }}>
          <div className="mb-4">
            <button
            ...
            <button
              className={`btn btn-sm maintainance-income-btn ${formType === 'tenant' ? 'maintainance-income-btn-active' : 'maintainance-income-btn-withoutbg'
                }`}
        ...
        <div
          ...
          style={{ maxWidth: "1550px", marginLeft: "325px", marginTop: "20px" }}
        >
          <form>
            ...
            <div
              style={{
                maxHeight: memberDropdownOpen ? "1000px" : "0",
                overflow: "hidden",
        ...
        <div className="container p-4" style={{ maxWidth: '1550px', marginLeft: '325px', marginTop: '20px' }}>
          <form>
        ...
        <div className="container-fluid " style={{ maxWidth: '1540px', marginLeft: '310px', marginTop: '20px' }}>
          <form onSubmit={handleSubmit}>
