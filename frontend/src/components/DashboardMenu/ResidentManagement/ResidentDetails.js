...
import { FaUser, FaHome, FaTag, FaPlusSquare } from 'react-icons/fa'; // Using react-icons as placeholders
    ...
    <div className="d-flex flex-column flex-md-row main-content" >
      ...
      <div className="flex-grow-1 p-4">
        <div className="container-fluid">
          <div className='bg-white' style={{ overflow: "hidden", padding: "20px" }}>
            ...
            <div className="table-responsive" style={{ border: "1px solid #ddd", borderRadius: "8px", boxShadow: "0px 0px 15px rgba(0, 0, 0, 0.1)", overflow: "hidden", backgroundColor: "#fff", padding: "20px", marginTop: "20px" }}>
              <div className="d-flex justify-content-between align-items-center ">
                ...
                <h4 className='mb-2'>Resident Tenant and Owner Details</h4>

                <Button
                  className="mainColor2 ms-3 flex-end d-flex align-items-center mb-4"
                  style={{
                    color: 'white',
                    padding: '10px 20px',
                    borderRadius: '8px',
                    ...
                    <tr key={index} className="align-middle">
                      ...
                      <td className="text-center"
                        ...
                        <div className="d-flex align-items-center justify-content-center">
                          <img src={editIcon} className="text-success me-2" onClick={handleOpenModal} style={{ cursor: "pointer", width: "24px" }} />
                          <img src={viewIcon} className="text-primary me-2" style={{ cursor: "pointer", width: "24px" }} />
                        </div>
                      </td>
                    </tr>
                  ))}
