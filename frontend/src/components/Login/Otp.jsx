  ...
  return (
    <div className="container-fluid min-vh-100 d-flex align-items-center">
      <div className="row w-100">
        <Logo />
        <div className="left-side col-lg-6 col-md-6 d-flex justify-content-center align-items-center bg-light">
          <div>
            <img
              src={OTPImage}
        ...
        <div className="right-sec col-lg-6 col-md-6 d-flex justify-content-center align-items-center">
          <div className="EnterOtp-form-container p-4 shadow-lg bg-white rounded" style={{ width: '400px' }}>
            ...
            <form onSubmit={handleSubmit(handleVerifyOtp)} className="d-flex flex-column align-items-center">
              ...
              <div className="d-flex justify-content-between w-100">
                ...
                {resendAvailable && (
                  <button onClick={resendOtp} type="button" className="btn btn-link p-0" style={{ color: '#ee6a42' }}>
                    Resend OTP
                  </button>
                )}
              </div>
